...
export function EnablePushButton({ audience, reservationId, variant = 'outline', size = 'sm', className, label }: Props) {
  ...
  const enable = async () => {
    ...
    try {
      ...
      if (perm !== 'granted') {
        toast.error('Permission refusée', { description: 'Activez les notifications dans les réglages du navigateur.' });
        return;
      }
