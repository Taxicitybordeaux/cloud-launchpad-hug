...
export function Skeleton({
  ...
  width?: number | string;
  height?: number | string; // ✅ accepte string ET number
...
/* ─── point 5 : Skeleton carte GPS (zone map pendant acquisition) ─── */
...
/* ─── point 5 : Liste des mises à jour GPS ─── */
...
/* ─── point 8 : Overlay de chargement global ─── */
