...
const FR: Record<LandingKey, LandingContent> = {
  airport: {
    ...
    description:
      "Réserver un taxi Bordeaux aéroport Mérignac : estimation du tarif à la réservation, véhicule 7 places sur demande. Un retard ? Appelez José directement — 06 73 07 23 22.",
    intro:
      "Moi c'est José. Ça fait des années que je fais la navette entre Bordeaux et Mérignac — matin, nuit, jours fériés compris. Vous me donnez l'heure de votre vol, je suis devant l'aéroport à votre sortie. Un retard ? Un coup de fil et j'ajuste.",
    sections: [
      {
        h: "Un retard ? Vous m'appelez, je m'adapte",
        p: "Vol en retard, en avance, escale qui décale tout : appelez-moi directement au 06 73 07 23 22 dès l'atterrissage, j'ajuste l'heure de prise en charge. Pas de formulaire, un appel suffit.",
      },
      {
        h: "Une estimation avant de monter",
        p: "Je vous donne une estimation du tarif dès la réservation, quel que soit votre quartier — centre-ville, Bassins à flot, Caudéran, Chartrons. Le prix définitif dépend du trajet réel.",
      },
      {
        h: "Familles, bagages, matériel — ça rentre",
        p: "La berline prend facilement 3 ou 4 valises, poussettes comprises. Siège enfant sur demande, prévenez-moi la veille. Pour un groupe, je passe sur un van 7 places.",
      },
    ],
    faq: [
      {
        q: "Combien coûte un taxi de Bordeaux centre à Mérignac ?",
        a: "En journée, comptez entre 30 et 45 € selon l'endroit exact d'où je viens vous chercher. La nuit et les dimanches, le tarif est un peu au-dessus (tarif réglementé). Je vous donne une estimation au moment de la réservation — le prix définitif dépend du trajet réel.",
      },
      {
        q: "Et si mon vol a du retard ?",
        a: "Appelez-moi directement au 06 73 07 23 22 dès que vous avez l'info, j'ajuste l'heure sans problème. Le temps de récupérer vos bagages est compris, pas d'attente facturée en plus.",
      },
      {
  ...
  station: {
    ...
    description:
      "Réserver un taxi à la gare Bordeaux Saint-Jean : prise en charge au quai, véhicule 7 places sur demande. Un retard ? Appelez José directement. 7j/7, 24h/24.",
    intro:
      "Je m'appelle José, je fais régulièrement Saint-Jean. TGV Paris, Ouigo, Intercités — je suis au point de rendez-vous qu'on aura fixé ensemble, pas besoin de tourner avec vos valises pour me trouver.",
    sections: [
      {
        h: "On se retrouve où vous voulez à la gare",
        p: "Dépose-minute côté Belcier, parvis principal côté ville, ou parking Effia — vous me dites où vous êtes le plus à l'aise. Je vous envoie un SMS avec la plaque quand j'arrive.",
      },
      {
        h: "Un imprévu SNCF ? Appelez-moi",
        p: "Retard, changement de voie, train en avance : un coup de fil au 06 73 07 23 22 et j'ajuste l'heure. Pas de formulaire à remplir.",
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Non — appelez-moi et j'ajuste mon arrivée, sans supplément. Pour une attente de plusieurs heures, on en parle à la réservation.",
      },
      {
  ...
  arcachon: {
    ...
    description:
      "Réserver un taxi Bordeaux → Arcachon, Pyla, Cap-Ferret : trajet direct, estimation du tarif à la réservation, véhicule 7 places pour familles et bagages. 06 73 07 23 22.",
    intro:
      "Bordeaux ↔ Arcachon, je le fais souvent — Dune du Pyla, week-ends à Cap-Ferret, habitués qui en ont marre du TER avec les valises. Un trajet que je connais par cœur.",
    sections: [
      {
      ...
      {
        h: "Une estimation avant de partir",
        p: "Je vous donne une estimation dès la réservation, avant même de monter — pas de mauvaise surprise si on est coincés sur l'A63 un vendredi soir.",
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Je vous donne une estimation à la réservation, selon le point de départ et l'heure. Le prix définitif dépend du trajet réel.",
      },
      {
  ...
  cpam: {
    ...
    intro:
      "Je suis José, taxi conventionné par l'Assurance Maladie à Bordeaux. Bon de transport signé par votre médecin, et vous n'avancez rien : je facture directement la CPAM et votre mutuelle. Beaucoup de dialyse, chimio, consultations à Pellegrin, Haut-Lévêque, Saint-André.",
    sections: [
      {
...
const EN: Record<LandingKey, LandingContent> = {
  airport: {
    ...
    sections: [
      ...
      },
      {
        ...
        p: "No surprises. You know the Bordeaux ↔ Mérignac airport fare before you get in.",
      },
      {
    ...
    faq: [
      {
        ...
        a: "Around €30–€45 in daytime depending on the pickup point. The exact fare is confirmed at booking.",
      },
      {
        q: "Will the taxi wait if my flight is delayed?",
        a: "Yes. We track your flight live and adjust the schedule — a reasonable wait after landing is included.",
      },
      {
        q: "Can I book in advance for an early-morning flight?",
        a: "Absolutely. We take bookings 24/7, including night and pre-dawn pickups.",
      },
    ],
    ctaBook: CTA.en.book,
    ctaCall: CTA.en.call,
    ...
    sections: [
      {
        ...
        p: "Meeting point agreed at booking: drop-off zone, forecourt, or car park. Your driver locates you and calls if needed.",
      },
      {
        h: "Live TGV tracking",
        p: "Delay, early arrival, platform change: the schedule adjusts automatically. Nothing to do on your side.",
      },
      {
    ...
    faq: [
      {
        ...
        a: "At the meeting point agreed with you (main forecourt, drop-off or car park). We notify you as soon as the driver arrives.",
      },
      {
      ...
      },
      {
        ...
        a: "Not for standard delays: we track the train and adjust. Extended waits may be billed at the regulated rate.",
      },
    ],
    ctaBook: CTA.en.book,
    ctaCall: CTA.en.call,
    ...
    sections: [
      {
        ...
        p: "From your hotel, station or airport in Bordeaux, all the way to Arcachon town, the Dune du Pyla, Cap-Ferret or Andernos — no transfer.",
      },
      {
        h: "Flat fare",
        p: "Price announced at booking, no hidden surcharge. Ideal for families, groups or tourists with luggage.",
      },
      {
        h: "Return trip organised",
        p: "Book outbound AND return in one go. We collect you at the agreed time and place.",
      },
    ],
    faq: [
      {
  ...
  cpam: {
    ...
    sections: [
      {
        h: "CPAM coverage",
        p: "Bring your transport voucher signed by your doctor. We handle billing directly with the health insurance.",
      },
      {
        h: "ALD: 100% covered",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Yes, we set up a fixed schedule for your regular sessions. Contact us to organise your appointments.",
      },
    ],
    ctaBook: CTA.en.book,
    ctaCall: CTA.en.call,
...
const ES: Record<LandingKey, LandingContent> = {
  airport: {
    ...
    intro:
      "Reserve su taxi al aeropuerto de Burdeos-Mérignac en segundos. Seguimos su vuelo en tiempo real y ajustamos la hora de recogida: su conductor le espera a la salida, incluso con retraso o adelanto.",
    sections: [
      {
      ...
      },
      {
        ...
        p: "Sin sorpresas. Conoce el precio Burdeos ↔ Aeropuerto Mérignac antes de subir.",
      },
      {
    ...
    faq: [
      {
        ...
        a: "Unos 30–45 € de día según el punto de salida. La tarifa exacta se confirma al reservar.",
      },
      {
        q: "¿El taxi espera si mi vuelo se retrasa?",
        a: "Sí. Seguimos su vuelo en directo y ajustamos el horario — una espera razonable tras el aterrizaje está incluida.",
      },
      {
        q: "¿Puedo reservar por anticipado para un vuelo temprano?",
        a: "Por supuesto. Aceptamos reservas 24/7, incluidas las recogidas nocturnas o al amanecer.",
      },
    ],
    ctaBook: CTA.es.book,
    ctaCall: CTA.es.call,
  ...
  station: {
    ...
    intro:
      "Un taxi le espera en la estación de Burdeos Saint-Jean, o le recoge para su TGV. Seguimos su tren y ajustamos la hora automáticamente.",
    sections: [
      {
        h: "Recogida en Saint-Jean",
        p: "Punto de encuentro acordado al reservar: zona de bajada, vestíbulo o aparcamiento. Su conductor le localiza y le llama si es necesario.",
      },
    ...
    faq: [
      {
        ...
        a: "En el punto de encuentro acordado (vestíbulo, zona de bajada o aparcamiento). Le avisamos cuando llegue el conductor.",
      },
      {
      ...
      },
      {
        ...
        a: "No para retrasos estándar: seguimos el tren y ajustamos. Una espera prolongada puede facturarse según tarifa regulada.",
      },
    ],
    ctaBook: CTA.es.book,
    ctaCall: CTA.es.call,
  ...
  arcachon: {
    ...
    intro:
      "Llegue a la Bahía de Arcachon en taxi desde el centro de Burdeos, el aeropuerto Mérignac o la estación Saint-Jean. Trayecto directo, precio conocido de antemano, sin transbordo.",
    sections: [
      {
      ...
      {
        h: "Tarifa cerrada",
        p: "Precio anunciado al reservar, sin recargos ocultos. Ideal para familias, grupos o turistas con equipaje.",
      },
  ...
  cpam: {
    ...
    intro:
      "Taxi concertado con la Seguridad Social francesa (CPAM) en Burdeos. Con su prescripción médica de transporte, el trayecto se factura directamente — sin adelantar dinero.",
    sections: [
      {
        h: "Cobertura CPAM",
        p: "Presente su bono de transporte firmado por su médico. Nos encargamos de la facturación directamente.",
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Sí, establecemos un horario fijo para sus sesiones regulares. Contáctenos para organizarlos.",
      },
    ],
    ctaBook: CTA.es.book,
    ctaCall: CTA.es.call,
...
const PT: Record<LandingKey, LandingContent> = {
  airport: {
    ...
    intro:
      "Reserve o seu táxi para o aeroporto de Bordéus-Mérignac em segundos. Seguimos o seu voo em tempo real e ajustamos a hora de recolha automaticamente.",
    sections: [
      {
    ...
    faq: [
      {
        ...
        a: "Cerca de 30–45 € de dia consoante o ponto de partida. O preço exato é confirmado na reserva.",
      },
      {
        q: "O táxi espera se o meu voo atrasar?",
        a: "Sim. Seguimos o voo em direto e ajustamos o horário — uma espera razoável após aterragem está incluída.",
      },
      {
  ...
  station: {
    ...
    intro:
      "Um táxi espera-o na estação de Bordéus Saint-Jean, ou vem buscá-lo para o seu TGV. Seguimos o comboio e ajustamos o horário automaticamente.",
    sections: [
      {
    ...
    faq: [
      {
        ...
        a: "No ponto de encontro combinado. Avisamo-lo assim que o motorista chegar.",
      },
      {
      ...
      },
      {
        ...
        a: "Não para atrasos padrão: seguimos o comboio e ajustamos. Esperas prolongadas podem ser faturadas à tarifa regulada.",
      },
    ],
    ctaBook: CTA.pt.book,
    ctaCall: CTA.pt.call,
  ...
  arcachon: {
    ...
    intro:
      "Chegue à Baía de Arcachon de táxi a partir do centro de Bordéus, do aeroporto Mérignac ou da estação Saint-Jean. Trajeto direto, preço conhecido, sem transbordo.",
    sections: [
      {
      ...
      {
        h: "Tarifa fixa",
        p: "Preço anunciado na reserva, sem taxas escondidas. Ideal para famílias, grupos ou turistas com bagagem.",
      },
  ...
  cpam: {
    ...
    intro:
      "Táxi convencionado com o seguro de saúde francês (CPAM) em Bordéus. Com a sua prescrição médica de transporte, o trajeto é faturado diretamente.",
    sections: [
      {
        h: "Cobertura CPAM",
        p: "Traga o seu voucher de transporte assinado pelo seu médico. Tratamos da faturação diretamente.",
      },
      {
...
const IT: Record<LandingKey, LandingContent> = {
  airport: {
    ...
    intro:
      "Prenoti il taxi per l'aeroporto di Bordeaux-Mérignac in pochi secondi. Monitoriamo il volo in tempo reale e adattiamo l'orario di ritiro automaticamente.",
    sections: [
      {
      ...
      },
      {
        ...
        p: "Nessuna sorpresa. Conosce il prezzo Bordeaux ↔ Aeroporto Mérignac prima di salire.",
      },
    ...
    faq: [
      {
        ...
        a: "Circa 30–45 € di giorno secondo il punto di partenza. La tariffa esatta è confermata alla prenotazione.",
      },
      {
        q: "Il taxi aspetta se il mio volo è in ritardo?",
        a: "Sì. Monitoriamo il volo in diretta e adattiamo l'orario — un'attesa ragionevole dopo l'atterraggio è inclusa.",
      },
      {
        q: "Posso prenotare in anticipo per un volo mattutino?",
        a: "Certamente. Accettiamo prenotazioni 24/7, comprese le corse notturne o all'alba.",
      },
    ],
    ctaBook: CTA.it.book,
    ctaCall: CTA.it.call,
  ...
  station: {
    ...
    intro:
      "Un taxi l'attende alla stazione di Bordeaux Saint-Jean, o viene a prenderla per il TGV. Monitoriamo il treno e adattiamo l'orario automaticamente.",
    sections: [
      {
        h: "Ritiro a Saint-Jean",
        p: "Punto d'incontro concordato: zona di sosta, atrio o parcheggio. L'autista la localizza e la chiama se necessario.",
      },
    ...
    faq: [
      {
        ...
        a: "Al punto d'incontro concordato. La avvisiamo appena arriva l'autista.",
      },
      {
      ...
      },
      {
        ...
        a: "No per ritardi standard: monitoriamo il treno e adattiamo. Un'attesa prolungata può essere fatturata alla tariffa regolamentata.",
      },
    ],
    ctaBook: CTA.it.book,
    ctaCall: CTA.it.call,
  ...
  arcachon: {
    ...
    intro:
      "Raggiunga la Baia di Arcachon in taxi dal centro di Bordeaux, dall'aeroporto Mérignac o dalla stazione Saint-Jean. Tragitto diretto, prezzo noto in anticipo.",
    sections: [
      {
      ...
      { h: "Tariffa forfettaria", p: "Prezzo annunciato alla prenotazione, senza costi nascosti." },
      {
        ...
        p: "Prenoti andata E ritorno insieme. Veniamo a prenderla all'ora e nel luogo concordati.",
      },
    ],
    faq: [
      {
  ...
  cpam: {
    ...
    intro:
      "Taxi convenzionato con l'assicurazione sanitaria francese (CPAM) a Bordeaux. Con la prescrizione medica di trasporto, la corsa è fatturata direttamente.",
    sections: [
      {
        h: "Copertura CPAM",
        p: "Porti il buono di trasporto firmato dal suo medico. Ci occupiamo della fatturazione direttamente.",
      },
      {
...
const AR: Record<LandingKey, LandingContent> = {
    ...
    faq: [
      {
        ...
        a: "حوالي 30–45 يورو نهارًا حسب نقطة الانطلاق. يُؤكد السعر الدقيق عند الحجز.",
      },
      {
        q: "هل تنتظر السيارة إذا تأخرت رحلتي؟",
        a: "نعم. نتابع رحلتك مباشرة ونضبط الجدول — انتظار معقول بعد الهبوط مشمول.",
      },
  ...
  arcachon: {
    ...
    intro:
      "اذهب إلى خليج أركاشون بسيارة أجرة من وسط بوردو أو مطار ميرينياك أو محطة سان-جان. رحلة مباشرة، سعر معروف مسبقًا.",
    sections: [
      {
  ...
  cpam: {
    ...
    intro:
      "سيارة أجرة معتمدة من التأمين الصحي الفرنسي (CPAM) في بوردو. مع وصفة النقل الطبية، تُفوتر الرحلة مباشرة — بدون دفع مسبق.",
    sections: [
