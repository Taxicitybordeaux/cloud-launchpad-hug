...
const fr: Dict = {
  ...
  "sim.km": "km",
  "sim.period": "Période",
  "sim.day": "Journée (lun-sam 7h-19h)",
  "sim.night": "Soirée, dimanche & jours fériés",
...
const en: Dict = {
  ...
  "home.best.cite.title": "Cité du Vin",
  "home.best.cite.sub": "A journey through the vineyards.",
  "home.best.emilion.title": "Saint-Émilion",
  "home.best.emilion.sub": "Medieval village & Grand Cru classé.",
  ...
  "sim.intro": "Enter your approximate distance and the time of day — we'll show you a ballpark figure.",
  "sim.distance": "Approximate distance",
  "sim.km": "km",
  "sim.period": "Time of day",
  "sim.day": "Daytime (Mon-Sat 7am-7pm)",
  "sim.night": "Evening, Sunday & public holidays",
...
const es: Dict = {
  ...
  "sim.intro": "Indica la distancia aproximada y el momento del día — te damos una estimación orientativa.",
  "sim.distance": "Distancia aproximada",
  "sim.km": "km",
  "sim.period": "Momento del día",
  "sim.day": "Día (lun-sáb 7h-19h)",
  "sim.night": "Noche, domingo y festivos",
...
const it: Dict = {
  ...
  "sim.intro": "Inserisci la distanza approssimativa e il momento della giornata — ti diamo una stima indicativa.",
  "sim.distance": "Distanza approssimativa",
  "sim.km": "km",
  "sim.period": "Momento della giornata",
  "sim.day": "Giorno (lun-sab 7-19)",
  "sim.night": "Sera, domenica e festivi",
...
const ar: Dict = {
  ...
  "sim.intro": "أدخل المسافة التقريبية والفترة الزمنية — سنعطيك تقديراً إرشادياً.",
  "sim.distance": "المسافة التقريبية",
  "sim.km": "كم",
  "sim.period": "الفترة",
  "sim.day": "نهاراً (الإثنين-السبت 7ص-7م)",
  "sim.night": "مساءً، الأحد والأعياد",
...
const pt: Dict = {
  ...
  "sim.intro": "Indique a distância aproximada e o período do dia — damos-lhe uma estimativa indicativa.",
  "sim.distance": "Distância aproximada",
  "sim.km": "km",
  "sim.period": "Período",
  "sim.day": "Dia (seg-sáb 7h-19h)",
  "sim.night": "Noite, domingo e feriados",
