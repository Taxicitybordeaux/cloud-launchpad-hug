...
const fr: Dict = {
  ...
  // Espace client
  "client.page.title": "Mon espace",
  "client.signin.title": "Se connecter à mon espace",
  "client.signin.subtitle": "Gérez vos courses et réservations",
  "client.signin.email": "Adresse e-mail",
  "client.signin.password": "Mot de passe",
  "client.signin.submit": "Se connecter",
  "client.signin.loading": "Connexion…",
  "client.signin.email_placeholder": "votre@email.fr",
  "client.signin.no_account": "Pas encore de compte ?",
  "client.signin.create": "Créer un compte",
  "client.header.subtitle": "Mon espace",
  "client.cta.new_booking.title": "Nouvelle réservation",
  "client.cta.new_booking.desc": "Réserver votre prochain taxi",
  "client.help.title": "Besoin d'aide ?",
  "client.help.cta": "Appeler",
  "client.list.empty": "Aucune course pour l'instant",
  "client.list.empty.cta": "Réserver une course",
  "client.card.from": "Départ",
  "client.card.to": "Arrivée",
  "client.card.estimate": "Estimation : ",
  "client.card.modify": "Modifier",
  "client.card.cancel": "Annuler",
  "client.card.rebook": "Reréserver",
  "client.modify.title": "Modifier l'heure de prise en charge",
  "client.modify.label": "Nouvelle heure",
  "client.modify.confirm": "Confirmer la modification",
  "client.logout": "Se déconnecter",
  "client.status.pending": "En attente",
  "client.status.accepted": "Acceptée",
  "client.status.en_route": "En route",
  "client.status.arrived": "Taxi arrivé",
  "client.status.completed": "Terminée",
  "client.status.cancelled": "Annulée",
};
...
const en: Dict = {
  ...
  // Espace client
  "client.page.title": "My account",
  "client.signin.title": "Sign in to your account",
  "client.signin.subtitle": "Manage your rides and bookings",
  "client.signin.email": "Email address",
  "client.signin.password": "Password",
  "client.signin.submit": "Sign in",
  "client.signin.loading": "Signing in…",
  "client.signin.email_placeholder": "you@email.com",
  "client.signin.no_account": "No account yet?",
  "client.signin.create": "Create an account",
  "client.header.subtitle": "My account",
  "client.cta.new_booking.title": "New booking",
  "client.cta.new_booking.desc": "Book your next taxi",
  "client.help.title": "Need help?",
  "client.help.cta": "Call",
  "client.list.empty": "No rides yet",
  "client.list.empty.cta": "Book a ride",
  "client.card.from": "Pickup",
  "client.card.to": "Drop-off",
  "client.card.estimate": "Estimate: ",
  "client.card.modify": "Edit",
  "client.card.cancel": "Cancel",
  "client.card.rebook": "Rebook",
  "client.modify.title": "Edit pickup time",
  "client.modify.label": "New time",
  "client.modify.confirm": "Confirm change",
  "client.logout": "Sign out",
  "client.status.pending": "Pending",
  "client.status.accepted": "Accepted",
  "client.status.en_route": "On the way",
  "client.status.arrived": "Taxi arrived",
...
const es: Dict = {
  ...
  // Espace client
  "client.page.title": "Mi espacio",
  "client.signin.title": "Iniciar sesión en mi espacio",
  "client.signin.subtitle": "Gestiona tus carreras y reservas",
  "client.signin.email": "Correo electrónico",
  "client.signin.password": "Contraseña",
  "client.signin.submit": "Iniciar sesión",
  "client.signin.loading": "Conectando…",
  "client.signin.email_placeholder": "tu@email.es",
  "client.signin.no_account": "¿No tienes cuenta todavía?",
  "client.signin.create": "Crear una cuenta",
  "client.header.subtitle": "Mi espacio",
  "client.cta.new_booking.title": "Nueva reserva",
  "client.cta.new_booking.desc": "Reserva tu próximo taxi",
  "client.help.title": "¿Necesitas ayuda?",
  "client.help.cta": "Llamar",
  "client.list.empty": "Ninguna carrera por ahora",
  "client.list.empty.cta": "Reservar una carrera",
  "client.card.from": "Salida",
  "client.card.to": "Llegada",
  "client.card.estimate": "Estimación: ",
  "client.card.modify": "Modificar",
  "client.card.cancel": "Cancelar",
  "client.card.rebook": "Reservar de nuevo",
  "client.modify.title": "Modificar hora de recogida",
  "client.modify.label": "Nueva hora",
  "client.modify.confirm": "Confirmar cambio",
  "client.logout": "Cerrar sesión",
  "client.status.pending": "Pendiente",
  "client.status.accepted": "Aceptada",
  "client.status.en_route": "En camino",
  "client.status.arrived": "Taxi llegado",
  "client.status.completed": "Finalizada",
...
const it: Dict = {
  ...
  // Espace client
  "client.page.title": "Il mio spazio",
  "client.signin.title": "Accedi al mio spazio",
  "client.signin.subtitle": "Gestisci le tue corse e prenotazioni",
  "client.signin.email": "Indirizzo e-mail",
  "client.signin.password": "Password",
  "client.signin.submit": "Accedi",
  "client.signin.loading": "Accesso…",
  "client.signin.email_placeholder": "tuo@email.it",
  "client.signin.no_account": "Non hai ancora un account?",
  "client.signin.create": "Crea un account",
  "client.header.subtitle": "Il mio spazio",
  "client.cta.new_booking.title": "Nuova prenotazione",
  "client.cta.new_booking.desc": "Prenota il tuo prossimo taxi",
  "client.help.title": "Serve aiuto?",
  "client.help.cta": "Chiama",
  "client.list.empty": "Nessuna corsa al momento",
  "client.list.empty.cta": "Prenota una corsa",
  "client.card.from": "Partenza",
  "client.card.to": "Arrivo",
  "client.card.estimate": "Stima: ",
  "client.card.modify": "Modifica",
  "client.card.cancel": "Annulla",
  "client.card.rebook": "Riprenota",
  "client.modify.title": "Modifica orario di ritiro",
  "client.modify.label": "Nuovo orario",
  "client.modify.confirm": "Conferma modifica",
  "client.logout": "Esci",
  "client.status.pending": "In attesa",
  "client.status.accepted": "Accettata",
  "client.status.en_route": "In arrivo",
  "client.status.arrived": "Taxi arrivato",
  "client.status.completed": "Completata",
  "client.status.cancelled": "Annullata",
};
...
const ar: Dict = {
  ...
  // Espace client
  "client.page.title": "مساحتي",
  "client.signin.title": "تسجيل الدخول إلى مساحتي",
  "client.signin.subtitle": "أدر رحلاتك وحجوزاتك",
  "client.signin.email": "البريد الإلكتروني",
  "client.signin.password": "كلمة المرور",
  "client.signin.submit": "تسجيل الدخول",
  "client.signin.loading": "جارٍ الاتصال…",
  "client.signin.email_placeholder": "you@email.com",
  "client.signin.no_account": "ليس لديك حساب بعد؟",
  "client.signin.create": "إنشاء حساب",
  "client.header.subtitle": "مساحتي",
  "client.cta.new_booking.title": "حجز جديد",
  "client.cta.new_booking.desc": "احجز سيارة الأجرة التالية",
  "client.help.title": "تحتاج إلى مساعدة؟",
  "client.help.cta": "اتصل",
  "client.list.empty": "لا توجد رحلات بعد",
  "client.list.empty.cta": "حجز رحلة",
  "client.card.from": "نقطة الانطلاق",
  "client.card.to": "الوجهة",
  "client.card.estimate": "التقدير: ",
  "client.card.modify": "تعديل",
  "client.card.cancel": "إلغاء",
  "client.card.rebook": "إعادة الحجز",
  "client.modify.title": "تعديل وقت الالتقاط",
  "client.modify.label": "الوقت الجديد",
  "client.modify.confirm": "تأكيد التعديل",
  "client.logout": "تسجيل الخروج",
  "client.status.pending": "قيد الانتظار",
  "client.status.accepted": "تم القبول",
  "client.status.en_route": "في الطريق",
  "client.status.arrived": "وصلت سيارة الأجرة",
  "client.status.completed": "منتهية",
  "client.status.cancelled": "ملغاة",
};
...
const pt: Dict = {
  ...
  // Espace client
  "client.page.title": "O meu espaço",
  "client.signin.title": "Entrar na minha conta",
  "client.signin.subtitle": "Gere as suas viagens e reservas",
  "client.signin.email": "Endereço de e-mail",
  "client.signin.password": "Palavra-passe",
  "client.signin.submit": "Entrar",
  "client.signin.loading": "A ligar…",
  "client.signin.email_placeholder": "voce@email.pt",
  "client.signin.no_account": "Ainda não tem conta?",
  "client.signin.create": "Criar uma conta",
  "client.header.subtitle": "O meu espaço",
  "client.cta.new_booking.title": "Nova reserva",
  "client.cta.new_booking.desc": "Reserve o seu próximo táxi",
  "client.help.title": "Precisa de ajuda?",
  "client.help.cta": "Ligar",
  "client.list.empty": "Nenhuma viagem por enquanto",
  "client.list.empty.cta": "Reservar viagem",
  "client.card.from": "Partida",
  "client.card.to": "Chegada",
  "client.card.estimate": "Estimativa: ",
  "client.card.modify": "Modificar",
  "client.card.cancel": "Cancelar",
  "client.card.rebook": "Reservar de novo",
  "client.modify.title": "Modificar hora de recolha",
  "client.modify.label": "Nova hora",
  "client.modify.confirm": "Confirmar alteração",
  "client.logout": "Sair",
  "client.status.pending": "Pendente",
  "client.status.accepted": "Aceite",
  "client.status.en_route": "A caminho",
  "client.status.arrived": "Táxi chegou",
