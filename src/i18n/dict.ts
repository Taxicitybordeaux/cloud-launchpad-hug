...
const ar: Dict = {
  ...
  "home.dest.gare.sub": "استقبال على الرصيف، مساعدة في الأمتعة.",
  "home.dest.airport.title": "مطار ميرينياك",
  "home.dest.airport.sub": "تتبع الرحلات، 15 دقيقة انتظار مجاناً.",
  ...
  "home.why.f2.d": "عرض سعر عند الطلب، الدفع بالبطاقة وكاش.",
  ...
  "svc.wedding.title": "حفلات الزفاف والمناسبات",
  "svc.wedding.desc": "سيارة أنيقة لأجمل لحظاتك.",
  "svc.cpam.title": "النقل الطبي CPAM",
  "svc.cpam.desc": "نقل صحي مغطى بالتأمين الصحي الفرنسي.",
  "svc.long.title": "المسافات الطويلة",
  "svc.long.desc": "رحلات في جميع أنحاء فرنسا حسب عرض السعر.",
  ...
  "services.cta": "اطلب عرض سعر / احجز",
  "services.b1": "24/7",
  "services.b2": "حتى 4 ركاب",
  "services.b3": "سائق محترف",
  "svcp.airport.title": "نقل من وإلى مطار ميرينياك",
  "svcp.airport.desc": "استقبال دقيق لرحلاتك، تتبع فوري، استقبال بلوحة الاسم عند الطلب.",
  "svcp.airport.p1": "تتبع الرحلات",
  "svcp.airport.p2": "ترحيب شخصي",
  ...
  "svcp.train.p1": "استقبال في المحطة",
  "svcp.train.p2": "مساعدة بالأمتعة",
  ...
  "svcp.wedding.title": "حفلات الزفاف والمناسبات",
  "svcp.wedding.desc": "سيارة أنيقة ومُعتنى بها لمرافقة أجمل لحظاتك.",
  "svcp.wedding.p1": "تزيين السيارة عند الطلب",
  "svcp.wedding.p2": "أسعار جزافية",
  "svcp.wedding.p3": "سائق ببدلة رسمية",
  "svcp.cpam.title": "النقل الطبي CPAM",
  "svcp.cpam.desc": "نقل احترافي جالس مغطى بالتأمين الصحي الفرنسي.",
  "svcp.cpam.p1": "فوترة مباشرة",
  "svcp.cpam.p2": "قبول وصفة النقل",
  "svcp.cpam.p3": "مستشفيات وعيادات",
  "svcp.long.title": "المسافات الطويلة",
  "svcp.long.desc": "رحلات في كل فرنسا وأوروبا حسب عرض السعر.",
  "svcp.long.p1": "عرض سعر مجاني",
  ...
  "tarifs.note": "تعرفة الليل من 19:00 إلى 07:00، أيام الأحد والعطل الرسمية. باقات المطار/المحطة متاحة حسب المنطقة.",
  "tarifs.cpam.title": "🏥 النقل الطبي CPAM",
  "tarifs.cpam.desc": "بوصفة نقل طبي، فوترة مباشرة للتأمين الصحي. لا دفع مقدماً.",
  "tarifs.event.title": "📅 باقات المناسبات",
  "tarifs.event.desc": "حفلات الزفاف، الندوات، السهرات: أسعار جزافية بعرض شخصي. اتصلوا بنا.",
  "tarifs.cta": "اطلب عرض سعر دقيق",
