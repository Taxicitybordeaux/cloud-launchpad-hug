...
const fr: Dict = {
  ...
  "sim.day": "Tarif jour (7h–19h) — 2,16 €/km",
  "sim.night": "Tarif nuit (19h–7h) — 3,24 €/km",
  "sim.partition": "{j}% jour / {n}% nuit",
  "sim.pickup": "Prise en charge : 2,83 €",
  "sim.loading": "⏳ Calcul de l'itinéraire…",
  "sim.distance": "Distance",
  "sim.duration": "Durée estimée",
  "sim.hint": "Saisissez le départ et la destination pour calculer automatiquement.",
  "sim.outbound": "Aller",
  "sim.return": "Retour",
  "sim.total": "TOTAL ESTIMÉ",
  "sim.total_round": "TOTAL ESTIMÉ (aller + retour)",
  "sim.mixed": "Tarif mixte — votre trajet déborde sur le tarif nuit",
  "sim.fees": "* Des frais de réservation peuvent être appliqués",
  "sim.indicative": "Prix indicatif — le compteur fait foi",
};
