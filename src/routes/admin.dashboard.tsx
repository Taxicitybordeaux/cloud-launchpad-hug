...
// 1. Définition des interfaces pour éviter les erreurs de type 'any'
...
function Dashboard() {
  ...
  return (
    <div style={{ padding: 20, fontFamily: "DM Sans, sans-serif", minHeight: "100vh", background: "#0f172a" }}>
            ...
            reservs.map((r) => {
              ...
              return (
                <SwipeableCard key={r.id} onDelete={() => deleteReservation(r.id)}>
                  ...
                  {prix !== null && (
                    <div style={{ marginTop: 8, color: "#0ea5e9", fontWeight: 700 }}>{prix.toFixed(2)} €</div>
                  )}
                  {r.status === "pending" && (
