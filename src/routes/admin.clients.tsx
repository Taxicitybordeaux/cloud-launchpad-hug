...
/**
 * SwipeRow — aligné sur le dashboard :
 * - touch only pour le swipe (pas de mouse drag)
 * - bouton 🗑 visible en desktop via la classe "desktop-delete"
 */
...
function ClientsPage() {
  ...
  const fetchAll = useCallback(async () => {
    ...
    // Index reservations par téléphone ou email du client
              ...
              <SwipeRow key={c.id} onDelete={() => deleteClient(c.id)}>
                ...
                {open[c.id] && (
                  <div style={{ marginTop: 12, borderTop: "1px solid rgba(255,255,255,0.06)", paddingTop: 12 }}>
                    ...
                    {/* Formulaire ajout course manuelle */}
