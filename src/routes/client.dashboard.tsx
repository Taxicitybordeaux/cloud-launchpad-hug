...
const css = `
  * { -webkit-tap-highlight-color: transparent; box-sizing: border-box; touch-action: manipulation; }
  ...
  .dashboard-header {
    ...
    background: linear-gradient(180deg, rgba(10,10,10,0.95) 0%, rgba(17,24,39,0.85) 100%);
  ...
  .dashboard-footer {
    ...
    max-width: 640px; width: 100%; z-index: 50;
  }
`;
...
function ClientDashboard() {
  ...
  // Notification "trajet récurrent créé"
  useEffect(() => {
  ...
  return (
    <>
      ...
      <main className="dashboard-root" dir={dir}>
        {/* Subtle gold halo */}
        <div
          aria-hidden
        ...
        <div className="dashboard-header">
          <div className="px-4 py-4">
            ...
            <div className="mt-4 grid gap-2">
              <Link
                to="/reserver"
                className="inline-flex items-center justify-center gap-2 rounded-xl px-4 py-3 text-sm font-semibold text-black transition active:scale-[0.98]"
              ...
              {(() => {
                ...
                const sameRideUrl = lastRide
                  ...
                  : null;
                return lastRide && sameRideUrl ? (
                  <a
                    href={sameRideUrl}
                    className="inline-flex items-center justify-center gap-2 rounded-xl border border-[#C9A84C]/40 bg-[#C9A84C]/10 px-4 py-3 text-sm font-semibold text-[#E8C96D] transition hover:bg-[#C9A84C]/20"
                  >
                  ...
                  return (
                    ...
                    >
                      <button
                        ...
                        className="flex w-full flex-col gap-2.5 p-4 text-left transition hover:bg-white/[0.03]"
                      >
                          ...
                          {editingId === r.id ? (
                            <div className="mb-4 flex gap-2">
                              ...
                              <button
                                ...
                                disabled={busy === r.id}
                                className="rounded-lg bg-[#E8C96D] px-3 py-2 text-xs font-semibold text-black transition active:scale-95 disabled:opacity-50"
                              >
                            ...
                            {isActive && CANCELLABLE.has(r.status) && (
                              <>
                                {editingId !== r.id && (
                                  ...
                                  >
                                    <Clock className="h-3.5 w-3.5" /> {t("cd_change_time")}
                                  </button>
                                )}
                                <button
                                  onClick={() => onCancel(r.id)}
                                  disabled={busy === r.id}
                                  className="inline-flex items-center gap-1.5 rounded-lg border border-red-500/30 bg-red-500/10 px-3 py-2 text-xs text-red-400 hover:bg-red-500/20 disabled:opacity-50"
                                >
        ...
        {chatId && session && (
          <ChatPanel
            ...
            clientIdentity={{ account_id: session.id, phone: session.phone, email: session.email }}
          />
        )}
