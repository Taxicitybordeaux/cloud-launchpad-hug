...
const URL = "https://taxicitybordeaux.fr/taxi-conventionne-bordeaux";
const c = getLanding("fr", "cpam");

export const Route = createFileRoute("/taxi-conventionne-bordeaux")({
  head: () => ({
    meta: [
      { title: c.title },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "TaxiService",
          name: "Taxi City Bordeaux — Conventionné CPAM",
