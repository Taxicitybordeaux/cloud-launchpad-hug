...
function SuiviPage() {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      if (r.chauffeur_id) {
        const { data: c } = await supabase.from("chauffeurs").select("*").eq("id", r.chauffeur_id).single();
    ...
    return (
      ...
      >
        <div style={{ textAlign: "center" }}>
          <div
            style={{ fontSize: 48, marginBottom: 16, animation: "spin 1s linear infinite", display: "inline-block" }}
          >
            🚕
          </div>
            ...
            <div>
              ...
              {eta !== null && resa.statut_course === "en_route" && (
                <div style={{ fontSize: 12, color: "#94a3b8", marginTop: 2 }}>
                  Arrivée estimée dans <strong style={{ color: "#f5c842" }}>{eta} min</strong>
                </div>
              )}
            </div>
          </div>
      ...
      >
        ...
        <div style={{ display: "flex", gap: 10, alignItems: "flex-start" }}>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", paddingTop: 4, flexShrink: 0 }}>
            ...
            <div
              style={{
                ...
                borderRadius: "50%",
                background: "#f5c842",
                boxShadow: "0 0 0 3px rgba(245,200,66,0.2)",
              }}
            />
          </div>
          ...
          <div style={{ textAlign: "right", flexShrink: 0 }}>
            ...
            <div style={{ fontSize: 18, fontWeight: 700, color: "#f5c842", fontFamily: "'Clash Display',sans-serif" }}>
              {resa.heure_course}
            </div>
          </div>
        </div>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 3 }}>
                ...
                <span style={{ fontSize: 12, color: "#64748b" }}>
                  {chauffeur.note_moyenne.toFixed(1)} ({chauffeur.nb_avis} avis)
                </span>
              </div>
            </div>
