...
const AR: Record<LandingKey, LandingContent> = {
  airport: {
    ...
    description: "احجز سيارة أجرة بوردو مطار ميرينياك: متابعة الرحلة، سعر مقطوع، تاكسي 7 مقاعد عند الطلب. 24/7 — +33 6 73 07 23 22.",
  ...
  station: {
    ...
    description: "احجز سيارة أجرة في محطة بوردو سان-جان: متابعة TGV، استلام على الرصيف، تاكسي 7 مقاعد عند الطلب. 24/7.",
  ...
  arcachon: {
    ...
    description: "احجز سيارة أجرة بوردو ← أركاشون (بيلا، كاب-فيري، الخليج): رحلة مباشرة، سعر مقطوع، تاكسي 7 مقاعد للعائلات والحقائب.",
  ...
  cpam: {
    ...
    description: "احجز سيارة أجرة معتمدة في بوردو: فوترة مباشرة (tiers payant)، ALD 100%، غسيل كلى، كيماوي. أيضاً تاكسي 7 مقاعد.",
