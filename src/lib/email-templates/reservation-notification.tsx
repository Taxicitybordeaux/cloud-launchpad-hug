  ...
  <Html lang="fr" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={lead}>
          Une nouvelle demande de course vient d'être enregistrée sur Taxi City Bordeaux.
        </Text>
        ...
        <Section style={card}>
          ...
          <Hr style={hr} />
          <Row label="Date / heure" value={p.pickup_datetime} />
        ...
        <Text style={footer}>
          Pensez à rappeler le client rapidement pour confirmer la course.
        </Text>
      </Container>
    </Body>
  </Html>
